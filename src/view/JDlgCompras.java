...
public class JDlgCompras extends javax.swing.JDialog {
   ...
   public JDlgCompras(java.awt.Frame parent, boolean modal) {
        ...
        Util.habilitar(false, jTxtIdCompra, jFmtData, jTxttotal, jCboCliente, jCboFornecedor, jBtnAlterarVp, jBtnExcluirVp,jBtnIncluirVp, jBtnConfirmar, jBtnCancelar );
     ...
     public ComprasMabs viewBean() {
       ...
       SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
         ...
         try {
            comprasMabs.setDataMabs(formato.parse(jFmtData.getText()));
        } catch (ParseException ex) {
    ...
    public void beanView(ComprasMabs compras) {
        ...
        jFmtData.setText(Util.dateStr(compras.getDataMabs()));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jFmtData, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnAlterarVpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarVpActionPerformed
        ...
        ComprasProdutoMabs compraProdutoMabs = (ComprasProdutoMabs) comprasProdutoControle.getBean(linSel);
        jDlgComprasProdutos.beanView(compraProdutoMabs);
      ...
      Util.habilitar(false, jBtnExcluir, jBtnIncluir, jBtnAlterar, jBtnPesquisar);
        ...
        if (comprasMabs != null) {
           ...
           comprasDAO = new ComprasDAO();
            ...
            Util.habilitar(true, jTxtIdCompra, jFmtData, jTxttotal, jCboFornecedor, jCboCliente, jBtnAlterarVp, jBtnExcluirVp,jBtnIncluirVp, jBtnConfirmar, jBtnCancelar);
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
       if (comprasMabs != null) {
            if (Util.perguntar("Deseja excluir a Compra ?") == true) {
                ...
                for (int linha = 0; linha < jTable1.getRowCount(); linha++) {
                    comprasProdutoMabs = comprasProdutoControle.getBean(linha);
                    comprasProdutoDAO.delete(comprasProdutoMabs);
                }
                comprasProdutoDAO.delete(comprasMabs);
               
            }
        } else {
            Util.mensagem("Deve ser realizada uma pesquisa antes");
        }
Util.limparCampos(jTxtIdCompra, jCboFornecedor, jFmtData, jCboCliente, jCboFornecedor, jTxttotal, jTable1);
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
        ...
        //habilitar(false);
        Util.limparCampos(jTxtIdCompra, jFmtData, jCboCliente, jCboFornecedor, jTxttotal);
...
//        Util.limparCampos(jTxtIdCompra, jTxtQuantidade, jTxttotal, jCboCliente, jCboFornecedor);
    ...
    private void jBtnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCancelarActionPerformed
       Util.limparCampos(jTxtIdCompra, jFmtData, jCboCliente, jCboFornecedor, jTxttotal);
        comprasProdutoControle.setList(new ArrayList());
        comprasMabs = null;
         Util.habilitar(false, jTxtIdCompra, jFmtData, jCboCliente, jCboFornecedor, jTxttotal, jBtnAlterarVp, jBtnExcluirVp,jBtnIncluirVp, jBtnConfirmar, jBtnCancelar);
        Util.habilitar(true, jBtnExcluir, jBtnAlterar, jBtnIncluir, jBtnPesquisar);
        
    }//GEN-LAST:event_jBtnCancelarActionPerformed

    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        Util.habilitar(true, jTxtIdCompra, jCboFornecedor, jFmtData, jTxttotal, jCboCliente, jCboFornecedor, jBtnConfirmar, jBtnCancelar, jBtnAlterarVp, jBtnIncluirVp, jBtnExcluirVp, jTable1);
        Util.habilitar(false, jBtnExcluir, jBtnIncluir, jBtnAlterar, jBtnPesquisar); // TODO add your handling code here:

        Util.limparCampos(jTxtIdCompra, jFmtData, jCboFornecedor, jCboCliente, jTxttotal);

        comprasProdutoControle.setList(new ArrayList());
        jTxtIdCompra.grabFocus();
        incluindo = true;
        comprasMabs = new ComprasMabs();
    ...
    Util.habilitar(false, jTxtIdCompra, jFmtData, jTxttotal, jCboCliente, jBtnExcluir, jBtnConfirmar, jBtnCancelar, jCboFornecedor);
