...
public class JDlgConsultasFornecedor extends javax.swing.JDialog {
    ...
    public JDlgConsultasFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Consulta a fornecedores");
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jTxtNacionalidade, javax.swing.GroupLayout.PREFERRED_SIZE, 338, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        if (jFmtTelefone.getText().equals("") && jTxtNacionalidade.getText().equals("")) {
            List lista = fornecedorDAO.listAll();
            fornecedorControle.setList(lista);
        } else {
            if (!jFmtTelefone.getText().equals("") && !jTxtNacionalidade.getText().equals("")) {
                List lista = fornecedorDAO.listTelefoneCidade(jFmtTelefone.getText(), jTxtNacionalidade.getText());
                fornecedorControle.setList(lista);
            } else {
                if (!jFmtTelefone.getText().equals("")) {
                    List lista = fornecedorDAO.listTelefone(jFmtTelefone.getText());
                    fornecedorControle.setList(lista);
                } else {
                    if (!jTxtNacionalidade.getText().equals("")) {
                        List lista = fornecedorDAO.listCidade(jTxtNacionalidade.getText());
                       fornecedorControle.setList(lista);
                    }
                }
            }
